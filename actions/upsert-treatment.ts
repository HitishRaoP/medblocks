...
export async function upsertTreatment(treatment: TreatmentFormType, treatmentId?: string) {
    ...
    try {
        ...
        return { message: `Treatment updated successfully`, treatmentId: generatedTreatmentId };
    } catch (error) {
